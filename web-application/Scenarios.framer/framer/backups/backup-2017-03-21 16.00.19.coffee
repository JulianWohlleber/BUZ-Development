...
sketch = Framer.Importer.load("imported/old-Wireframe-Screen-Framer@1x")
...
sceneHandler = (selectedScenario) ->
	if selectedScenario is "regional"
		...
		Trend.stateCycle(test[index])
		display(Description_Regional, Title_Regional)
		...
		generateTrendStates(currentSceneTrends)
		display(Description_Fortress, Title_Fortress)
		...
		generateTrendStates(currentSceneTrends)
		display(Description_Robotic, Title_Robotic)
		...
		generateTrendStates(currentSceneTrends)
		display(Description_Virtual, Title_Virtual)
