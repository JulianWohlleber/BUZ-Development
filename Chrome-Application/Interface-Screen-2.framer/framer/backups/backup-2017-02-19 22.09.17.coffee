...
Title_Regional.superlayer = SuperLayer_Regional
Title_Fortress.superlayer = SuperLayer_Fortress
Title_Robotic.superlayer = SuperLayer_Robotic
Title_Virtual.superlayer = SuperLayer_Virtual
...
updateTrends = (color, trends, mySuperLayer) ->
	if SuperLayer_Regional is true
		SuperLayer_Regional.destroy()
	if SuperLayer_Fortress is true
		SuperLayer_Fortress.destroy()
	if SuperLayer_Robotic is true
		SuperLayer_Robotic.destroy()
	if SuperLayer_Virtual is true
